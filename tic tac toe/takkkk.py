...
def CheckWinner():
    ...
    if winner ==1:
        ...
        messagebox.showinfo(title="Congratulations.", 
            message="congratulation player2")
    elif mov ==9:
...
def Restart():
    global p1,p2,mov,ActivePlayers
    p1.clear(); p2.clear()
    mov,ActivePlayers = 0,1
    root.title("Tic Tac Toe  game: Player 1")
    EnableAll()
